...
from automarl.components.rl.policy.stochastic_policy import NormalStochasticPolicy
...
def hyperparameter_suggestions():
    ...
    return [
        ...
        VariableListHyperparameterSuggestion(
            ...
            max_len=3,
            hyperparameter_localizations=[
                ["input","agents_input","policy",1,"model",1,"models",1,1,"layers"]
            ],
        ...
        VariableListHyperparameterSuggestion(
            ...
            max_len=2,
            hyperparameter_localizations=[
                ["input","rl_trainer",1,"agents_trainers_input","learner",1,
                 "critic_model",1,"models",1,1,"layers"]
            ],
            hyperparameter_suggestion_for_list=
                SingleHyperparameterSuggestion(
                    value_suggestion=("cat",{"choices":[32,64,128,256]})
        ...
        VariableListHyperparameterSuggestion(
            ...
            max_len=4,
            hyperparameter_localizations=[
                ["input","agents_input","policy",1,"model",1,"child_components",0,1,"layers"]
            ],
            hyperparameter_suggestion_for_list=
                SingleHyperparameterSuggestion(
        ...
        DisjointHyperparameterSuggestion(
            ...
            hyperparameter_localizations=[
                ["input","agents_input","policy",1,"model",1,"models",1,1,"parameters_initialization_strategy"],
                ["input","rl_trainer",1,"agents_trainers_input","learner",1,"critic_model",1,"models",1,1,"parameters_initialization_strategy"],
                ["input","agents_input","policy",1,"model",1,"child_components",0,1,"parameters_initialization_strategy"]
            ],
            allow_none=True,
            disjoint_hyperparameter_suggestions=[
